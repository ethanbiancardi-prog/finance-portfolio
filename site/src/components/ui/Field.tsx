...
export const labelClasses = "block text-[10px] caps text-zinc-500";
...
export const inputClasses =
  "field-input mt-0.5 border-0 border-b border-border bg-transparent px-0 py-1 text-sm tabular-nums text-foreground transition-colors placeholder:text-zinc-600 hover:border-zinc-500 focus:border-accent focus:shadow-none";
